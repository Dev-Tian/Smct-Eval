...
export default function OverviewTab() {
  ...
  }, [searchTerm, currentPage, statusFilter, quarterFilter, yearFilter]);
                          ...
                          <TableCell className="px-6 py-3">
                            <div className="flex gap-2">
                              <Button
                                ...
                                className="text-xs px-2 py-1 bg-green-600 hover:bg-green-500 hover:text-white text-white cursor-pointer hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
                              >
                                ☰ View
                              </Button>
                              <Button
                                ...
                                className="text-xs px-2 py-1 bg-red-300 hover:bg-red-500 text-gray-700 hover:text-white border-red-200 cursor-pointer hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
