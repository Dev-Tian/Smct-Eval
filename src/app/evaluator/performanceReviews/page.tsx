...
export default function performanceReviews() {
  ...
  const insights = useMemo(() => {
    ...
    if (parseFloat(String(average)) >= 4.5) {
      insightsList.push({
        type: 'excellent',
        icon: '🏆',
    ...
    } else if (parseFloat(String(average)) >= 4.0) {
      insightsList.push({
        type: 'good',
        icon: '⭐',
    ...
    } else if (parseFloat(String(average)) >= 3.5) {
      insightsList.push({
        type: 'average',
        icon: '📈',
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-2 border-t">
                    ...
                    <Badge
                      className={
                        parseFloat(String(average)) >= 4.5
                          ? 'bg-green-100 text-green-800'
                          : parseFloat(String(average)) >= 4.0
                            ? 'bg-blue-100 text-blue-800'
                            : parseFloat(String(average)) >= 3.5
