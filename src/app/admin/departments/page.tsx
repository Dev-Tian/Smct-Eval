...
export default function DepartmentsTab() {
  ...
  const handleDeleteDepartment = async () => {
    ...
    try {
      if (
        Number(departmentToDelete.employees_count) + Number(departmentToDelete.managers_count) !==
        0
      ) {
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-2">
              <Button
                ...
                className="flex items-center gap-2 bg-green-600 text-white hover:bg-green-700 hover:text-white hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
              >
              ...
              <Button
                ...
                className="flex items-center gap-2 bg-blue-600 text-white hover:bg-green-700 hover:text-white hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                {isRefreshing ? (
                  <>
                          ...
                          <>
                            <CardHeader>
                              <CardTitle className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2">
                                  <Badge variant="outline">{dept.employees_count} employees</Badge>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    onClick={() => {
                                    ...
                                    className="h-8 w-8 p-0 text-red-600 hover:text-red-700 hover:bg-red-50 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
                                  >
          ...
          <DialogFooter className="pt-6 px-2">
            <div className="flex justify-end space-x-4 w-full cursor-pointer">
              ...
              <Button
                ...
                className="bg-green-500 text-white hover:bg-green-600 hover:text-white cursor-pointer hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Add Department
              </Button>
            </div>
        ...
        <DialogContent className={`max-w-md p-6 ${dialogAnimationClass}`}>
              ...
              <div className="text-sm text-gray-700">
                ...
                <div className="mt-2 space-y-1">
                  ...
                  <p>
                    ...
                    {(isNaN(Number(departmentToDelete?.employees_count))
                      ? 0
                      : Number(departmentToDelete?.employees_count)) +
                      (isNaN(Number(departmentToDelete?.managers_count))
                        ? 0
          ...
          <DialogFooter className="pt-6 px-2">
            <div className="flex justify-end space-x-4 w-full cursor-pointer">
              ...
              <Button
                className="bg-blue-600 hover:bg-red-700 text-white cursor-pointer hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300"
