    ...
    <div className="relative">
      <div className="flex gap-4 mb-5">
        <Card className="w-1/4">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-gray-900">{dashboardTotals?.total_users}</div>
                        ...
                        <TableRow key={review.id} className={rowClassName}>
                          ...
                          <TableCell className="px-6 py-3">
                            <Button
                              variant="outline"
                              size="sm"
                              className="text-xs px-2 py-1 bg-green-600 hover:bg-green-700 hover:text-white text-white hover:scale-110 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
