    ...
    <>
      <div className="flex gap-3 mb-3">
        ...
        <Card className="w-1/4">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-yellow-600">{newEval || 0}</div>
        ...
        <Card className="w-1/4">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-orange-600">{pendingEval || 0}</div>
        ...
        <Card className="w-1/4">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-600">{completedEval || 0}</div>
        ...
        <Card className="w-1/4">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-blue-600">{totalEmployees || 0}</div>
            ...
            <CardTitle className="flex items-center gap-2">
              ...
              {(() => {
                ...
                submissions.filter((sub) => {
                  const hoursDiff =
                    (now.getTime() - new Date(sub.created_at || '').getTime()) / (1000 * 60 * 60);
                  return hoursDiff <= 24;
                }).length;
                return newCount > 0 ? (
                        ...
                        >
                          ...
                          <TableCell className="px-3 py-2 md:px-4 md:py-2.5 lg:px-6 lg:py-3 text-left pl-0">
                            {submission.rating && (
                              ...
                              >
                                {submission.rating > 0 ? `${submission.rating}/5` : 'N/A'}
                              </Badge>
                            )}
                          </TableCell>
                          <TableCell className="px-3 py-2 md:px-4 md:py-2.5 lg:px-6 lg:py-3">
                            <Badge
                              className={`${getQuarterColor(
                                submission.reviewTypeProbationary || submission.reviewTypeRegular
                              )} text-xs md:text-sm`}
                            >
