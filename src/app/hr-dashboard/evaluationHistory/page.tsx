                    ...
                    {myEvaluations.map((submission: any) => {
                      ...
                      return (
                        <TableRow key={submission.id} className={rowClassName}>
                          ...
                          <TableCell className="w-1/6 text-center">
                            <Button
                              className="bg-blue-500 text-white hover:bg-green-700 hover:text-white cursor-pointer hover:scale-110 not-first:shadow-lg hover:shadow-xl transition-all duration-300"
                              size="sm"
