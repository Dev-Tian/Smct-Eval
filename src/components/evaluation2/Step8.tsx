            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Encourages the team to complete a critical project ahead of
                    the deadline while maintaining quality.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      value={String(data.managerialSkillsScore1 || "")}
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore1", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Recognizes and rewards team achievements to maintain high
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore2", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Evaluates a situation, assesses needs, considers
                    alternatives, and implements solutions that benefit the team
                    and the company.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore3", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Develops a timeline for team deliverables, ensuring tasks
                    are assigned based on workload and skills.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      value={String(data.managerialSkillsScore4 || "")}
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore4", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Holds one-on-one meetings to discuss individual performance
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore5", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Mediates conflict between team members, ensuring a
                    collaborative solution that benefits the group.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      value={String(data.managerialSkillsScore6 || "")}
                      onValueChange={(value) =>
                        handleScoreChange("managerialSkillsScore6", value)
                      }
                      placeholder="-- Select --"
                    />
                  </td>
        ...
        <CardContent className="pt-6">
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">
              Managerial Skills - Average Score
            </h3>
            <div className="flex justify-center items-center gap-6">
              <div
                className={`px-6 py-4 rounded-lg border-2 ${getAverageScoreColor(averageScoreNumber)}`}
              >
                ...
                <div className="space-y-1 text-sm">
                  <div>
                    ...
                    <span className="font-semibold">
                      {data.managerialSkillsScore1 || "Not rated"}
                    </span>
                  </div>
                  <div>
                    Team Management & Development:{" "}
                    <span className="font-semibold">
                      {data.managerialSkillsScore2 || "Not rated"}
                    </span>
                  </div>
                  <div>
                    Decision-Making & Problem-Solving:{" "}
                    <span className="font-semibold">
                      {data.managerialSkillsScore3 || "Not rated"}
                    </span>
                  </div>
                  <div>
                    Performance Management & Coaching:{" "}
                    <span className="font-semibold">
                      {data.managerialSkillsScore4 || "Not rated"}
                    </span>
                  </div>
                  <div>
                    Communication & Influence:{" "}
                    <span className="font-semibold">
                      {data.managerialSkillsScore5 || "Not rated"}
                    </span>
                  </div>
                  <div>
                    [Skill Name]:{" "}
                    <span className="font-semibold">
                      {data.managerialSkillsScore6 || "Not rated"}
                    </span>
                  </div>
                </div>
              </div>
