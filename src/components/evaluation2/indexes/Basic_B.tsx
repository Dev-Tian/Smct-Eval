...
import Basic_B_Overall from "../overall/Basic_B_Overall";
import Step2_Basic_B from "../Step2_Basic_B";
...
export default function Basic_B_EvaluationForm({
  employee,
  onCloseAction,
  onCancelAction,
}: EvaluationFormProps) {
  ...
  const defaultSteps = [
    ...
    { id: 2, title: "Quality of Work", component: Step2_Basic_B },
    ...
    { id: 9, title: "Overall Assessment", component: Basic_B_Overall },
  ];
              ...
              <div className="flex justify-between mt-6">
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="px-6 bg-red-500 text-white border-red-300 hover:bg-red-500 hover:text-white cursor-pointer hover:scale-110 transition-transform duration-200"
                  >
                    Cancel Evaluation
                  </Button>
                </div>
