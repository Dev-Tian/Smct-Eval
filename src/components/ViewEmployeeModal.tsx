...
export default function ViewEmployeeModal({
  ...
  const employeeIdValue =
    (employee as any)?.emp_id || (employee as any)?.employeeId || (employee as any)?.employee_id;
      ...
      >
        ...
        <div className="sticky top-0 z-50 flex justify-end mb-4 -mt-6 -mr-6 pt-6 pr-6">
          <Button
            ...
            className={`bg-blue-600 hover:bg-red-700 text-white shadow-lg hover:shadow-xl cursor-pointer hover:scale-110 transition-transform duration-200 ${
        ...
        <DialogHeader
          className={`pb-6 ${
            isAdminVariant ? 'border-b-2 border-slate-300' : 'border-b border-gray-200'
          }`}
        >
          <DialogTitle
          ...
          <DialogDescription
            className={`text-base mt-2 ${isAdminVariant ? 'text-slate-600' : 'text-gray-600'}`}
          >
        ...
        <div className="space-y-6 mt-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3 mt-3">
                    ...
                    >
                      ...
                      {(Array.isArray(employee.roles) && employee.roles[0]?.name) ||
                        employee.roles?.name ||
                        'Not Assigned'}
                    </Badge>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Hash
                      className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-blue-600'}`}
                    />
                  </div>
                  <div>
                    <Label
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Mail
                      className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-green-600'}`}
                    />
                  </div>
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <Phone
                        className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-teal-600'}`}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <Label
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Briefcase
                      className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-orange-600'}`}
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <Label
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Building2
                      className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-purple-600'}`}
                    />
                  </div>
                  <div className="flex-1 min-w-0">
                    <Label
            ...
            {(employee.branches?.branch_name ||
              (Array.isArray(employee.branches) && employee.branches[0]?.branch_name)) && (
              <Card
                className={`${
                  isAdminVariant
                    ? 'bg-slate-50 border-2 border-slate-300 shadow-md hover:shadow-lg'
              ...
              >
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <MapPin
                        className={`w-5 h-5 ${isAdminVariant ? 'text-slate-700' : 'text-cyan-600'}`}
                      />
                    </div>
                    <div className="flex-1 min-w-0">
                      <Label
